...
global.owner = process.env.OWNER_NUMBER  || '923193619280' ;  // ADD YOUR NUMBER WITHOUT +
    
module.exports = {
SESSION_ID: process.env.SESSION_ID || 'VAJIRA-MD=GRkHWKbC#4KXwIE_--XV_1NpRCgERgHcySuivLsJXkhBvjLsjJ4o' ,
travaSend: process.env.TRAVA_SEND || '25' ,   
MODERATORS : process.env.MODERATORS === undefined ? "923193619280,923193619280" : process.env.MODERATORS ,    
